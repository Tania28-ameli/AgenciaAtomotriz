...
namespace Presentacion_TallerAutomotiz
{
    public partial class FrmAgregarHerramientas : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            if (FrmHerramientas.idh >0 )
            {
                mh.Modificar(FrmHerramientas.idh,txtCodigoHerramienta, txtNombre, txtMarca, txtMedida, txtDescripcion);
                FrmHerramientas.idh = 0;
                ...
                MessageBox.Show(mh.GuardarHerramientas(txtCodigoHerramienta, txtNombre, txtMarca, txtMedida, txtDescripcion));
            txtCodigoHerramienta.Clear();
            txtNombre.Clear();
            txtMarca.Clear();
            txtMedida.Clear();
